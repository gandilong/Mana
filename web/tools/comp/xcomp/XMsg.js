...
Thang.XMsg=Ext.extend(Ext.Window,{
	                     width:300,
						 height:200,
						 showTime:6000,
						 closeAction:'hide',
						 ...
						 showAnimDuration:.6,
						 html:'<b>Have a good time !</b>',
					     constructor:function(config){
							 config=config||{};
						     Ext.apply(this,config);

						     Thang.XMsg.superclass.constructor.call(this);
						 },
						 animShow:function(){
                           	   this.el.slideIn('b', {
									easing: 'easeOut',
						 ...
						 onRender:function(ct,position){
							 Thang.XMsg.superclass.onRender.call(this, ct, position);
						 ...
						 show:function(){
							 Thang.XMsg.superclass.show.call(this);
							 this.close.defer(this.showTime,this);
						 },
					     close:function(){
                             if(this.isAutoClose){
